...
class HikkaConfigMod(loader.Module):
    ...
    async def inline__set_config(
        ...
        await call.edit(
            ...
            reply_markup=[
                [
                    {
                        "text": self.get_string("back_btn"),
                        "callback": self.inline__configure,
                        "args": (mod,),
                        "kwargs": {"obj_type": obj_type},
                    },
                    {"text": self.get_string("close_btn"), "action": "close"},
                ]
            ],
    ...
    async def inline__set_bool(
        ...
        await call.edit(
            self.get_string(
                ...
                (
                    self.get_string("typehint").format(
                        doc,
        ...
        return [
            [
                *(
                    [
                        {
                            "text": f"❌ {self.get_string('set')} `False`",
                    ...
                    if self.lookup(mod).config[option]
                        ...
                        {
                            "text": f"✅ {self.get_string('set')} `True`",
                            "callback": self.inline__set_bool,
            ...
            [
                *(
                    [
                        {
                            "text": self.get_string("set_default_btn"),
    ...
    def _generate_series_markup(
        ...
        return [
            [
                {
                    "text": self.get_string("enter_value_btn"),
                    "input": self.get_string("enter_value_desc"),
            ...
            [
                *(
                    [
                        {
                            "text": self.get_string("remove_item_btn"),
                            "input": self.get_string("remove_item_desc"),
                            "handler": self.inline__remove_item,
                            "args": (mod, option, call.inline_message_id),
                            "kwargs": {"obj_type": obj_type},
                        },
                        {
                            "text": self.get_string("add_item_btn"),
                            "input": self.get_string("add_item_desc"),
    ...
    async def inline__configure_option(
        ...
        if (
            ...
            additional_button_row = (
                [
                    [
                        {
                            "text": self.get_string("hide_value"),
                            "callback": self.inline__configure_option,
                ...
                if force_hidden
                    ...
                    [
                        {
                            "text": self.get_string("show_hidden"),
                            "callback": self.inline__configure_option,
        ...
        try:
            ...
            if validator.internal_id == "Boolean":
                await call.edit(
                    ...
                    reply_markup=additional_button_row
    ...
    async def inline__choose_category(self, call: Message | InlineCall):
        await utils.answer(
            call,
            self.get_string("choose_core"),
            reply_markup=[
                [
                    {
                        "text": self.get_string("settings"),
                        "callback": self.lookup("HikkaSettings").inline__settings,
                    },
                    {
                        "text": self.get_string("builtin"),
                        "callback": self.inline__global_config,
                        "kwargs": {"obj_type": True},
                    },
                    {
                        "text": self.get_string("external"),
                        "callback": self.inline__global_config,
                    },
                ],
                *(
                    [
                        [
                            {
                                "text": self.get_string("libraries"),
                                "callback": self.inline__global_config,
    ...
    async def fconfig(self, message: Message):
        ...
        if option not in instance.config:
            await utils.answer(message, self.get_string("no_option"))
            return
